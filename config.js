...
//═══════[Required Variables]════════\\
global.owner = process.env.OWNER_NUMBER.split("03348552641")
global.mongodb = process.env.MONGODB_URI || "mongodb://mongo:MYv2JYVQXcb7dOIvNYzd@containers-us-west-103.railway.app:7808"
global.port= process.env.PORT || 5000
global.email = 'sam@sec.live'
global.github = 'https://github.com/prabathLK/PRABATH-MD'
global.location = 'Sultanpur IN'
global.gurl = 'https://instagram.com/' // add your username
global.devs = '923348552641';
...
module.exports = {
  ...
  dl_limit: process.env.DL_SIZE || '700',
  art: process.env.AUTO_RESTART || 'true',
  sudo: process.env.SUDO || '923348552641',
  ...
  sessionName: process.env.SESSION_ID || '0q01iQQB#glXMEW4Yjcb8VneKliPa_nlD2qwgVFELLzbbdLuk7eg',
  author: process.env.PACK_INFO.split(";")[0] || 'author', 
  auto_read_status : process.env.AUTO_READ_STATUS || 'false',
  packname: process.env.PACK_INFO.split(";")[1] || 'abdul wahab',
  ...
  BRANCH: 'main',
  ALIVE_MESSAGE: process.env.ALIVE_MESSAGE || ' hi bro i am alive',
